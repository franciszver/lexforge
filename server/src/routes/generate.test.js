...
import { DEFAULT_MODEL, ALLOWED_MODELS } from '../aiConfig.js';

// Ported from demo-proxy/server.test.js (P3.5): the /api/generate contract
// moves into server/ unchanged. /healthz is already covered by app.test.js
...
describe('POST /api/generate', () => {
  ...
  it('does not require an Authorization header / JWT (unauthenticated by design)', async () => {
    fetchMock.mockResolvedValueOnce(okUpstreamResponse());
