...
export const DEMO_CLAUSES = [
    {
        ...
        documentTypes: JSON.stringify(['Contract', 'Agreement']),
        usageCount: 42,
    ...
    },
    {
        ...
        jurisdiction: 'Federal',
        documentTypes: JSON.stringify(['NDA', 'Agreement']),
        usageCount: 37,
    ...
    },
    {
        ...
        jurisdiction: 'Federal',
        documentTypes: JSON.stringify(['Contract', 'Service Agreement']),
        usageCount: 21,
        variations: JSON.stringify([]),
        placeholders: JSON.stringify([]),
        isPublished: true,
    ...
    },
    {
        ...
        jurisdiction: 'Federal',
        documentTypes: JSON.stringify(['Service Agreement', 'License Agreement']),
        usageCount: 18,
        variations: JSON.stringify([]),
        placeholders: JSON.stringify([]),
        isPublished: true,
    ...
    },
    {
        ...
        jurisdiction: 'Federal',
        documentTypes: JSON.stringify(['Contract', 'Agreement', 'Lease']),
        usageCount: 12,
        variations: JSON.stringify([]),
        placeholders: JSON.stringify([]),
        isPublished: true,
    ...
    },
    {
        ...
        jurisdiction: 'Federal',
        documentTypes: JSON.stringify(['Service Agreement', 'Partnership Agreement']),
        usageCount: 9,
        variations: JSON.stringify([]),
        placeholders: JSON.stringify([]),
        isPublished: true,
